...
public interface BaseService<Record, Example> {
	 ...
	 * @return
	 */
	List<Record> selectByExample(Example exmple);
	 ...
	 * @return
	 */
	List<Record> selectByExampleForOffsetPage(Example example, Integer offset, Integer limie);
